...
function send() { 
    ...
    lenght_divide_2 = Math.floor(number.lenght/2)
...
function check() {
    ...
    if(question_turn == "player1") {
        ...
        document.getElementById("player_question").innerHtml = "Quesetion Turn - " + player2_name;
    }
    else {
        question_turn = "player1"
        document.getElementById("player_question").innerHtml = "Quesetion Turn - " + player1_name;    
    }
    if(answer_turn == "player1") {
        answer_turn = "player2"
        document.getElementById("player_answer").innerHtml = "Answer Turn - " + player2_name;
